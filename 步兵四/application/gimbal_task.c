...
void set_cali_gimbal_hook(const uint16_t yaw_offset, const uint16_t pitch_offset, const fp32 max_yaw, const fp32 min_yaw, const fp32 max_pitch, const fp32 min_pitch)
{
    ...
    gimbal_control.gimbal_pitch_motor.max_relative_angle = min_pitch;
    gimbal_control.gimbal_pitch_motor.min_relative_angle = max_pitch;
}
...
static void gimbal_absolute_angle_limit_pitch(gimbal_motor_t *gimbal_motor, fp32 add)
{
	...
	{
		gimbal_motor->absolute_angle_set=(gimbal_motor->min_relative_angle+0.1);
	}
